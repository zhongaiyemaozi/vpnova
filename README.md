...
VPNova 是一款面向 Apple 平台的规则代理工具客户端，当前公开包覆盖 iOS/iPadOS、macOS、tvOS 和 visionOS。它用于管理用户自己的代理节点，并根据域名、IP、地理位置和兜底规则选择代理、直连或拒绝连接。
...
当前发布的安装包是未签名二次签名包，不能保证直接安装；用户需要使用自己的 Apple 证书、描述文件和 entitlements 重新签名。
...
- 在 iPhone、iPad、Mac、Apple TV 或 Apple Vision 设备上测试网络连通性
...
- 流量统计：实时上传/下载速度、流量用量
- 原生体验：SwiftUI 风格界面，支持 iPhone/iPad、Mac、Apple TV、Apple Vision、深色模式、浅色模式、英文和简体中文
...
- 设备：iPhone、iPad、Mac、Apple TV 或 Apple Vision
- 系统：iOS/iPadOS 15.0+、macOS 13.0+、tvOS 17.0+、visionOS 1.0+
